...
- Preserve HALO's native architecture: frozen CrossMAE visual features, local attention, differentiable top-k history retrieval, joint imitation/VQA training, and the native action policy.
- Adapt only what RoboMME requires. Do not replace HALO with another policy backbone.
...
- Store generated data, checkpoints, and runs under `/data/ed1116/robomme`; never commit them.
